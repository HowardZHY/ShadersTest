...
const vec3 ToD[25] = vec3[25](vec3(240.0,120.0,48.0), //hour,r,g,b
								vec3(240.0,120.0,48.0),
								vec3(240.0,120.0,48.0),
								vec3(240.0,120.0,48.0),
								vec3(240.0,120.0,48.0),
								vec3(240.0,120.0,48.0),
								vec3(240.0,120.0,48.0),
								vec3(240.0,150.0,80.0),
								vec3(240.0,180.0,110.0),
								vec3(240.0,195.0,145.0),
								vec3(240.0,199.0,157.0),
								vec3(240.0,200.0,170.0),
								vec3(240.0,200.0,180.0),
								vec3(240.0,200.0,170.0),
								vec3(240.0,199.0,157.0),
								vec3(240.0,195.0,145.0),
								vec3(240.0,180.0,110.0),
...
float mcosS = max(cosS*0.7+0.3,0.0);				
	...
	const vec3 moonlight = vec3(1.0, 0.9, 1.4) * 0.001;
	...
	vec3 sky_color = vec3(0.2, 0.35, 1.);
