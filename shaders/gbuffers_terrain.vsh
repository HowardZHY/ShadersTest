...
void main() {
	...
	float skyL = lmcoord.t*1.2-0.5/16.0*1.2;
	...
	const vec3 moonlight = vec3(1.2, 1.0, 1.0) * 0.006;
	...
	vec2 trCalc = min(abs(worldTime-vec2(23200.0,12800.0)),800.0);
	...
	float diffuse = (worldTime > 12800 && worldTime < 23200)? -NdotL : NdotL;
